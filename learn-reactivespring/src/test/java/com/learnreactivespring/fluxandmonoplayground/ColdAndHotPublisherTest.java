...
@Test
    ...
    public void hotPublisherTest() throws InterruptedException {
        ...
        Thread.sleep(3000);
        connectableFlux.subscribe((s)-> System.out.println("Subscriber2: "+s)); //doesnot emit values from beginning
        Thread.sleep(4000);//stock pickers are example of hot publisher
